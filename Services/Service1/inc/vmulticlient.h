...
BOOL vmulti_connect(pvmulti_client vmulti,int i);
...
BOOL vmulti_update_multitouch(pvmulti_client vmulti, PTOUCH pTouch, BYTE actualCount,BYTE request_type,BYTE report_control_id);
